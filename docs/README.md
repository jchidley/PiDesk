...
Pi's RPC implementation and the PiDesk source code are the canonical references for current runtime behaviour. The improvement plan is the canonical statement of intended work in this repository.
